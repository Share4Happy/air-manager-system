...
export function Svg_User({ w, h, c }) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" style={{ width: `${w}`, height: `${h}` }} fill={c ? c : 'var(--main)'}>
...
export function Svg_Tuition({ w, h, c }) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512" style={{ width: `${w}`, height: `${h}` }} fill={c ? c : 'var(--main)'}>
      <path d="M64 64C28.7 64 0 92.7 0 128v256c0 35.3 28.7 64 64 64h448c35.3 0 64-28.7 64-64V128c0-35.3-28.7-64-64-64H64zm112 160h48c8.8 0 16 7.2 16 16s-7.2 16-16 16h-48v32c0 8.8-7.2 16-16 16s-16-7.2-16-16v-32h-16c-8.8 0-16-7.2-16-16s7.2-16 16-16h16v-16c0-8.8 7.2-16 16-16s16 7.2 16 16v16zm160 0c8.8 0 16 7.2 16 16s-7.2 16-16 16h-48c-8.8 0-16-7.2-16-16s7.2-16 16-16h48zm64 96c0 8.8-7.2 16-16 16h-96c-8.8 0-16-7.2-16-16s7.2-16 16-16h96c8.8 0 16 7.2 16 16zm-128-80v32c0 8.8-7.2 16-16 16h-48c-8.8 0-16-7.2-16-16v-32c0-8.8 7.2-16 16-16h48c8.8 0 16 7.2 16 16z" />
    </svg>
  )
}

export function Svg_Graduation({ w, h, c }) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" style={{ width: `${w}`, height: `${h}` }} fill={c ? c : 'var(--main)'}>
      <path d="M256 64c-8.1 0-16.1 1.4-23.7 4.1L15.8 169.4C6.3 172.9 0 181.9 0 192s6.3 19.1 15.8 22.6l216.5 75.3c7.6 2.7 15.6 4.1 23.7 4.1s16.1-1.4 23.7-4.1L496.2 214.6c9.5-3.4 15.8-12.4 15.8-22.6s-6.3-19.1-15.8-22.6L279.7 68.1C272.1 65.4 264.1 64 256 64zM73.9 317.4c-9.5-3.4-20-1.5-26.3 5.2s-9.1 15.9-5.6 24.5l6.1 15c5.8 14.3 18.4 24.5 33.8 27.5L239.5 426c5.5.8 11.1.8 16.6 0l151.7-20.1c15.4-2.9 28-13.1 33.8-27.5l6.1-15c3.5-8.6.7-18.3-5.6-24.5s-16.9-8.6-26.3-5.2L256 371 73.9 317.4zm0 64c-9.5-3.4-20-1.5-26.3 5.2s-9.1 15.9-5.6 24.5l6.1 15c5.8 14.3 18.4 24.5 33.8 27.5L239.5 490c5.5.8 11.1.8 16.6 0l151.7-20.1c15.4-2.9 28-13.1 33.8-27.5l6.1-15c3.5-8.6.7-18.3-5.6-24.5s-16.9-8.6-26.3-5.2L256 435 73.9 381.4z" />
    </svg>
  )
}

export function Svg_Close({ w, h, c }) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 320 512" style={{ width: `${w}`, height: `${h}` }} fill={c ? c : 'var(--main)'}>
...
export function Svg_Guide({ w, h, c }) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" style={{ width: `${w}`, height: `${h}` }} fill={c ? c : 'var(--main)'}>
...
export function Svg_Feedback({ w, h, c }) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" style={{ width: `${w}`, height: `${h}` }} fill={c ? c : 'var(--main)'}>
...
export const Svg_Event = ({ w = 22, h = 22, c }) => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512" style={{ width: `${w}px`, height: `${h}px` }} fill={c ? c : 'var(--main_d)'}>
      <path d="M400 0H176c-26.5 0-48 21.5-48 48v32H48C21.5 80 0 101.5 0 128v32c0 70.7 57.3 128 128 128h14.7c27.8 48.5 76.6 83.2 134.3 93.1V432H208c-17.7 0-32 14.3-32 32s14.3 32 32 32h160c17.7 0 32-14.3 32-32s-14.3-32-32-32h-69v-50.9c57.7-9.9 106.5-44.6 134.3-93.1H448c70.7 0 128-57.3 128-128v-32c0-26.5-21.5-48-48-48h-80V48c0-26.5-21.5-48-48-48zM128 224c-35.3 0-64-28.7-64-64v-32h64v96zm384-64c0 35.3-28.7 64-64 64v-96h64v32z" />
    </svg>
  )
}